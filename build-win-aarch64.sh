...
cp native/build-aarch64/src/Release/Wrath.exe build/win-aarch64/
cp target/Wrath.jar build/win-aarch64/
...
echo Wrath.exe aarch64 sha256sum
sha256sum build/win-aarch64/Wrath.exe

dumpbin //HEADERS build/win-aarch64/Wrath.exe
