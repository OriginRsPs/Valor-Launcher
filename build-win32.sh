...
cp native/build-x86/src/Release/SpawnPVP.exe build/win-x86/
cp target/SpawnPVP.jar build/win-x86/
...
echo SpawnPVP.exe 32bit sha256sum
sha256sum build/win-x86/SpawnPVP.exe

dumpbin //HEADERS build/win-x86/SpawnPVP.exe
