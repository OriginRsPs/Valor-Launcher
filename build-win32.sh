...
cp native/build-x86/src/Release/Valor.exe build/win-x86/
cp target/Valor.jar build/win-x86/
...
echo Valor.exe 32bit sha256sum
sha256sum build/win-x86/Valor.exe

dumpbin //HEADERS build/win-x86/Valor.exe
