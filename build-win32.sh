...
cp native/build-x86/src/Release/Wrath.exe build/win-x86/
cp target/Wrath.jar build/win-x86/
...
echo Wrath.exe 32bit sha256sum
sha256sum build/win-x86/Wrath.exe

dumpbin //HEADERS build/win-x86/Wrath.exe
