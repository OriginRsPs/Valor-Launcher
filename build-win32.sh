...
cp native/build-x86/src/Release/BaseScape.exe build/win-x86/
cp target/BaseScape.jar build/win-x86/
...
echo BaseScape.exe 32bit sha256sum
sha256sum build/win-x86/BaseScape.exe

dumpbin //HEADERS build/win-x86/BaseScape.exe
