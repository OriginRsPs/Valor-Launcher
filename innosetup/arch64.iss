...
AppSupportURL=https://wrathrsps.com/
...
OutputDir=${basedir}
OutputBaseFilename=WrathSetupAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-aarch64\Wrath.exe"; DestDir: "{app}"
Source: "${basedir}\build\win-aarch64\Wrath.jar"; DestDir: "{app}"
