...
cp native/build-x64/src/Release/Wrath.exe build/win-x64/
cp target/Wrath.jar build/win-x64/
...
echo Wrath.exe 64bit sha256sum
sha256sum build/win-x64/Wrath.exe

dumpbin //HEADERS build/win-x64/Wrath.exe
