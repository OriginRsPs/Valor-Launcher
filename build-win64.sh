...
cp native/build-x64/src/Release/BaseScape.exe build/win-x64/
cp target/BaseScape.jar build/win-x64/
...
echo BaseScape.exe 64bit sha256sum
sha256sum build/win-x64/BaseScape.exe

dumpbin //HEADERS build/win-x64/BaseScape.exe
