...
cp native/build-x64/src/Release/SpawnPVP.exe build/win-x64/
cp target/SpawnPVP.jar build/win-x64/
...
echo SpawnPVP.exe 64bit sha256sum
sha256sum build/win-x64/SpawnPVP.exe

dumpbin //HEADERS build/win-x64/SpawnPVP.exe
