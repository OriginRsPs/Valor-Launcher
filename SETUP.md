...
1) Go into launcher.properties And edit 'wrath' and links to your server links and name
...
runelite.download.link=https://**Wrath**.net/download/  
runelite.website=https://**Wrath**.net/  
runelite.bootstrap=https://Wrath.s3.eu-west-2.amazonaws.com/bootstrap.json  
runelite.bootstrapsig=https://Wrath.s3.eu-west-2.amazonaws.com/bootstrap.json.sha256  
runelite.name=**Wrath**  
...
Make sure CC is selected and replace 'Wrath' with 'MyCoolName' MAKE SURE ITS CAPS E same with the server name

3) Inside Intellij click the root of the project and press CTRL + ALT + R

Make sure CC is selected and replace 'Wrath' with 'myCoolName' MAKE SURE ITS LOWERCASE E same with the server name
...
Once you have pushed your files to github, github actions will build your launcher you can then find them under the workflow action it runs EG: https://github.com/Wrath-Community/Runelite-Launcher-rsps/actions/runs/3014844052
